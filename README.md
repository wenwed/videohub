...
| 请求方式 | post |
| 请求参数 | 114514.jpg |
| 返回示例 | `{ code: 200, use_poster: "1919810.jpg" }` |
...
| 请求方式 | post |
| 请求参数 | |
| 返回示例 | `{status: 200, msg: "视频上传成功", video: "20200914204412_12027.mp4"}` |
...
| 验证码 | |
| -------- | -------- |
| 请求URL  | http://127.0.0.1:8633/api/getsafecode |
| 简要描述 | 获取验证码，将验证码保存在cookie的captcha中 |
| 请求方式 | get |
| 请求参数 | |
| 返回示例 | |
